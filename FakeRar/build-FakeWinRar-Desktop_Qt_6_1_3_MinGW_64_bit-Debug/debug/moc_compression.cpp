...
#include <memory>
#include "../../FakeWinRar/compression.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Compression_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Compression_t qt_meta_stringdata_Compression = {
    {
QT_MOC_LITERAL(0, 11), // "Compression"
QT_MOC_LITERAL(12, 8), // "mysigals"
QT_MOC_LITERAL(21, 0) // ""

    },
    "Compression\0mysigals\0"
};
...
void Compression::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Compression *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->mysigals(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Compression::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Compression::mysigals)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Compression::staticMetaObject = { {
    ...
    qt_meta_stringdata_Compression.offsetsAndSize,
    qt_meta_data_Compression,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Compression_t
